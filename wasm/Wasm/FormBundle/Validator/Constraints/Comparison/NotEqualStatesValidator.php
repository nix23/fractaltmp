...
class NotEqualStatesValidator extends ConstraintValidator
{
    public function validate($object, Constraint $constraint)
    {
        ...
        if($this->areStatesNotEqual($object, $allProps[0], $subprops))
            return;
    ...
    private function areStatesNotEqual($object, $mainProp, $subprops)
    {
